...
The block is abridged: `balance-sheet` also prints, beneath the gain keys, the working that shows how each was reached, which `--no-itemize` leaves off.
