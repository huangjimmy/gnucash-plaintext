...
> An unposted invoice is drawn by GnuCash's own Printable Invoice, which prices it from its
> entries and marks it "Invoice in progress…". The crash and the refusal to drop unposted
> pages stand; the draft badge and the provisional-tax caption described below were part of
