...
`tests/fixtures/us_dollars_spent_from_two_banks_one_stating_no_cost_basis.txt`
spends 100.00 USD out of one bank stating that bank's cost basis, and 50.00 USD
out of a second bank stating none.

`tests/fixtures/us_dollars_spent_from_the_bank_stating_a_loans_cost_basis.txt`
spends 100.00 USD out of the bank stating the cost basis of a loan, which stands
...
TWO_BANKS = 'tests/fixtures/us_dollars_spent_from_two_banks_one_stating_no_cost_basis.txt'
A_LOANS_COST_BASIS = 'tests/fixtures/us_dollars_spent_from_the_bank_stating_a_loans_cost_basis.txt'
...
class TestASplitStatingNoCostBasisBesideOneThatStatesOne:
...
class TestAHeldSplitStatingTheCostBasisOfADebt:
    def test_the_sale_is_refused(self, tmp_path):
