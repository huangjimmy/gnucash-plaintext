...
whose action is set to `Material`, saved and reopened, reads back `Material`. One field, shown
...
class TestALedgerThatNamesNoneOfThem:
    ...
    them carries all of them, at the values GnuCash sets on an untouched entry:
