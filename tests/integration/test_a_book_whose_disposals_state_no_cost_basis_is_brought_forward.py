"""A book holding a disposal that states no cost basis, exported and imported again.
...
every ledger meets: the purchase opens a cost basis, and the spend that states
none is refused.
...
def test_the_rest_is_imported_and_lists_the_cost_basis_to_state(tmp_path):
    ledger = _exported(tmp_path)
