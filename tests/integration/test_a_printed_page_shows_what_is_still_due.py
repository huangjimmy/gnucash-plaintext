"""What a printed page says is owed, after what has been paid on it.
...
Both invoices here are CAD in a CAD book, paid from a CAD bank, so what is
...
`test_a_printed_page_totals_in_its_own_currency`, which measures it.
"""
