"""A payment block giving its transaction and an account that transaction did not use is refused.
...
gives the payment's transaction by `txn_guid:`, and that transaction moved the
