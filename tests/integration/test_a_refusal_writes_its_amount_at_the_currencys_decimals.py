"""A disposal stating no cost basis is refused with its amount written as the ledger writes it.
...
SPEND = 'tests/fixtures/a_spend_of_45_50_usd_stating_no_cost_basis.txt'
