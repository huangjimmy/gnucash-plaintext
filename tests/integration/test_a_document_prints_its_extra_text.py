"""The two free-text blocks a document carries beyond GnuCash's page.
...
rating — and the document goes to the other party.
"""
...
LEDGER = str(FIXTURES / 'a_document_with_extra_text.txt')
...
class TestWhereEachBlockLands:
    ...
    def test_a_page_with_nowhere_to_put_it_is_refused(self):
        ...
        out differently must not yield a document that looks right, goes to a
