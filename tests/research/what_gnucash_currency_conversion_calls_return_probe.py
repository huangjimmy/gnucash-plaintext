"""What GnuCash's own currency conversion calls return on a multi-currency book, on this build (Q-042).
...
Every call goes through ctypes: SWIG misreads a date passed as seconds on 3.4
(CLAUDE.md finding 20).

Run: ./scripts/run.sh <tag> env PYTHONPATH=/workspace python3 tests/research/what_gnucash_currency_conversion_calls_return_probe.py
"""
